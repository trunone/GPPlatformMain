...
#ifndef _STRA_TEST_H_
#define _STRA_TEST_H_
...
namespace Robot
{
	class Stra_Test : public StrategyModule
	{
	typedef enum
	{
	...
	private:
		static Stra_Test* m_UniqueInstance;
	...
	public:
		static Stra_Test* GetInstance() { return m_UniqueInstance; }
