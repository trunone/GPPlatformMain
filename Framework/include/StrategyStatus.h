...
namespace Robot
{
	...
	public:
		...
		static TCoordinate DinRMAStarPos;
		static TCoordinate LibAStarPos;
		static TCoordinate BedRMAStarPos;
		static TCoordinate ThiefPos;
		static int FlagEatBall;
		...
		static TCoordinate BluePos;
		static TCoordinate RedPos;
		static TCoordinate GreenPos;
	};
}
#endif
