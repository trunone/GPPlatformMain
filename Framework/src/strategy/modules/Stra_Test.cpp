...
Stra_Test* Stra_Test::m_UniqueInstance = new Stra_Test();
...
//---------------------------------------------------------------------------
void Stra_Test::Initialize(void)
{
...
//---------------------------------------------------------------------------
void Stra_Test::SetAStar( TCoordinate  Goal )
{
...
//---------------------------------------------------------------------------
bool Stra_Test::MotionToPosition( TCoordinate  Goal )
{
...
//---------------------------------------------------------------------------
bool Stra_Test::TurnToAngle( float GoalAngle )
{
...
//---------------------------------------------------------------------------
bool Stra_Test::SpecialMove( int Forward )
{/*
...
//---------------------------------------------------------------------------
void Stra_Test::EncounterPeople()
{
