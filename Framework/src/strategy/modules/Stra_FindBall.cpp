...
//    if( this->bNewParameter ) this->ParameterReset();
    ...
    if(StrategyStatus::Room.SKSRoomState == StrategyStatus::etSKSCatchBall)
    {
        ...
        case etInitial:
            ...
            switch(RoomCnt)
            {
            case Def_LivingRoom: case Def_Library:

            case Def_DiningRoom: case Def_BedRoom:
...
int  Stra_FindBall::DisTransfer(int AX12_CMD)
{
    ...
    case 32: Distance = 200; break;

    case 33: Distance = 110; break;

    case 34: Distance = 74;  break;

    case 35: Distance = 59;  break;

    case 36: Distance = 44;  break;

    case 37: Distance = 35;  break;

    case 38: Distance = 29;  break;

    case 39: Distance = 24;  break;

    case 40: Distance = 22;  break;

    case 41: Distance = 18;  break;
